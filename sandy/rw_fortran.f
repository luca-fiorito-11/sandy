...
c
c
      subroutine rcont(string,c1,c2,l1,l2,n1,n2,mat,mf,mt,ns,io_status)
      real*8 :: c1,c2
      integer:: l1,l2,n1,n2,mat,mf,mt,ns,io_status
      character*80 :: string
Cf2py intent(inout) string
Cf2py intent(inout) c1,c2,l1,l2,n1,n2,mat,mf,mt,ns,io_status
  10  format (2E11.0, 4I11, I4, I2, I3, I5)
      read(string, 10, iostat=io_status) c1,c2,l1,l2,n1,n2,mat,mf,mt,ns
...
c
c
      subroutine rcontrol(string,mat,mf,mt,ns,io_status)
