...
def read_mf2(tape, mat):
    ...
    >>> df[f"NIS {0}"][f"NER {0}"]["LRU = 1 LRF = 1 or 2 NRO = 0"][f"List {0}"]["GT"]
        [0.0251, 0.0252, 0.0351, 0.0371, 0.0323, 0.0375, 0.039, 0.0287, 0.0283, 0.0504, 0.0308, 
         0.0659, 0.0331, 0.028, 0.0312, 0.0509, 0.0489, 0.0709, 0.1009, 0.0484, 0.0311, 0.0809]
