...
def read_mf10(tape, mat, mt):
    ...
    >>> text = read_mf10(tape, 4125, 16)
    >>> print(text)
    {'MAT': 4125, 'MF': 10, 'MT': 16, 'ZA': 41093.0, 'AWR': 92.10827, 'LIS': 0, 'LFS': {0: {'QM': -8830560.0, 'QI': -8830560.0, 'IZAP': 41092, 'NBT': [31], 'INT': [2], 'E': array([8.92643e+06, 9.00000e+06, 9.50000e+06, 1.00000e+07, 1.05000e+07,
