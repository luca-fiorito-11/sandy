...
def read_mf10(tape, mat, mt):
    ...
    Examples
    --------
    >>> read_mf10(sandy.get_endf6_file("jeff_33", 'xs', 410930),4125,16)
    {'MAT': 4125,
     'MF': 10,
     'MT': 16,
     'ZA': 41093.0,
...
#    >>> write_mf10(read_mf10(sandy.get_endf6_file("jeff_33", 'xs', 410930),4125,16))
